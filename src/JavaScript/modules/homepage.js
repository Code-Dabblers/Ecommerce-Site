            ...
            <div class="homepage__wrapper">
                <section class="homepage__main">
                    <div class="homepage__main__img-wrapper">
                        <img
                            ...
                            alt="main-banner-shoe"
                        />
                        <div class="homepage__main-title">
                            <h1 class="homepage__main-text">
                                Super Flash Sale 50% Off
                            </h1>
                        </div>
                    </div>

                    <div class="homepage__main-sale">${flashSale()}</div>
                </section>
                ...
                <section class="best-sellers">
                    <div class="best-sellers__header">
                        <h3>Best Sellers</h3>
                        <a class="best-sellers__header--link" href="#"
                            >See more</a
                        >
                    </div>
                    ...
                    <h3 class="best-sellers__load">
                        <a class="best-sellers__load-link" href="#"
                            >Load more</a
                        >
                    </h3>
                </section>
                ...
                <section class="testimonials">
                    <div class="testimonials__img">
                        <img
                            src="${testimonialImage.default}"
                            class="testimonials__img--1"
                            alt="Testimonial background"
                        />
                        <img
                            src="${girl.default}"
                            class="testimonials__img--2"
                    ...
                    <div class="testimonials__text">
                        ...
                        <div class="testimonials__p-wrapper">
                            <p class="testimonials__p">
                                Loving my new KAILI watch from @matoa_id, the
                                first ever Indonesian watch local brand that
                                uses wood as their main material. Like any other
                                Matoa products, KAILI is inspired by Indonesian
                                heritage.
                        ...
                        <div class="testimonials__arrows">
                            <i
                                class="fa fa-long-arrow-alt-left arrow-left active-arrow"
                            ></i>
                            <i
                                class="fa fa-long-arrow-alt-right arrow-right"
                            ></i>
                        </div>
                    </div>
                </section>
